...
// module.exports = mongoose.model('companies', schema) // single connection connection(url, options)
module.exports = schema // multi-connection createConnection(url, options)
